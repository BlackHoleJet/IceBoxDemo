...
import com.smart_haier.pengliang.amapdemo.util.AMapUtil;
import com.smart_haier.pengliang.amapdemo.util.ToastUtil;
...
public class PoiKeywordSearchActivity extends FragmentActivity implements
        ...
        OnPoiSearchListener, OnClickListener, AMapLocationListener {
    private AMap aMap;
